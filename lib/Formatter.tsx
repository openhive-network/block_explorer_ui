...
private getAverageRate(
  ...
  if (!hbdVal) return ""; // Avoid division by zero

  // The output should be like "0.19 HIVE/HBD"
  return `${(hiveVal / hbdVal).toFixed(3)} HIVE/HBD`;
}
  ...
  formatFillOrderOperation({
    ...
    if (avgRate) {
      messageElements.push(
        this.i18n.t("formatter.formatFillOrderOperation.atAvgRatePrefix"),
        avgRate
      );
    }
