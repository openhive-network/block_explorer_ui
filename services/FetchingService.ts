...
class FetchingService {
  ...
  async getHeadBlockNum(): Promise<number> {
    const url = `${config.apiAddress}/${config.apiSubtype}/get_head_block_num`;
  ...
  async getBlock(blockNumber: number): Promise<Hive.BlockDetails> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_block`;
  ...
  async getLastBlocks(limit: number): Promise<Hive.LastBlocksTypeResponse[]> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_latest_blocks `;
    return await this.makePostRequest(url, requestBody);
  }

  async getInputType(input: string): Promise<Hive.InputTypeResponse> {
    const requestBody: Hive.GetInputTypeProps = { _input: input };
    const url = `${config.apiAddress}/${config.apiSubtype}/get_input_type`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getBlockOpTypes(blockNumber: number): Promise<Hive.OperationTypes[]> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_block_op_types`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getOpsByBlock(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_ops_by_block`;
    return await this.makePostRequest(url, requestBody);
  }
  async getTransaction(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_transaction`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getAccOpTypes(account: string): Promise<unknown> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_acc_op_types`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getOpsByAccount(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_ops_by_account`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getAccountOperationsCount(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_account_operations_count`;
    return await this.makePostRequest(url, requestBody);
  }

  async getAccount(account: string): Promise<unknown> {
    const requestBody: Hive.GetAccountProps = { _account: account };
    const url = `${config.apiAddress}/${config.apiSubtype}/get_account`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getAccountResourceCredits(account: string): Promise<unknown> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_account_resource_credits`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getBtrackerAccountBalance(account: string): Promise<unknown> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_btracker_account_balance`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getWitnesses(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_witnesses`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getWitnessesVotersNum(witness: string): Promise<unknown> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_witness_voters_num`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getWitnessVoters(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_witness_voters`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getOperationTypes(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_matching_operation_types`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getWitness(witnessName: string): Promise<Hive.Witness> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_witness`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getBlockByTime(date: Date): Promise<number> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_block_by_time`;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getOperationKeys(operationTypeId: number): Promise<string[][]> {
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_operation_keys `;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getBlockByOp(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_block_by_op  `;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getWitnessVotesHistory(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_witness_votes_history  `;
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getOperation(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_operation`
    return await this.makePostRequest(url, requestBody);
  }
  ...
  async getCommentOperation(
    ...
    const url = `${config.apiAddress}/${config.apiSubtype}/get_comment_operations`
    return await this.makePostRequest(url, requestBody);
  }

  async getHafbeVersion(): Promise<string> {
    const requestBody = {};
    const url = `${config.apiAddress}/${config.apiSubtype}/get_hafbe_version`;
    return await this.makePostRequest(url, requestBody);
  }
