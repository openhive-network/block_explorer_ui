...
//communities info
const CommunitiesPageInfo: React.FC = () => {
  const { t } = useI18n();
  return (
    <ul className="list-disc list-inside space-y-1">
      <li>{t("communitiesPage.description1")}</li>
      <li>{t("communitiesPage.description2")}</li>
      <li>{t("communitiesPage.description3")}</li>
      <li>{t("communitiesPage.description4")}</li>
      <li>{t("communitiesPage.description5")}</li>
    </ul>
  );
};
...
"pageTitle.communities": {
  en: <CommunitiesPageInfo />,
  es: <CommunitiesPageInfo />,
  it: <CommunitiesPageInfo />,
  de: <CommunitiesPageInfo />,
  pt: <CommunitiesPageInfo />,
  fr: <CommunitiesPageInfo />,
  pl: <CommunitiesPageInfo />,
  zh: <CommunitiesPageInfo />,
  ja: <CommunitiesPageInfo />,
  ro: <CommunitiesPageInfo />,
  ar: <CommunitiesPageInfo />
}
