...
test.describe("Home page - account searches", () => {
  ...
  test("Validate that Account Search is impossible without Account Name - Search button is not clickable", async ({
    page,
  }) => {
  ...
  test.skip("Validate that got results for Account Name property", async ({
    page,
  }) => {
    await mainPage.accountSearchSection.click();
    await page.waitForTimeout(1000);
  ...
  test.skip("Validate that got results for Account Name and Last days/weeks/months properties", async ({
    page,
  }) => {
    await mainPage.accountSearchSection.click();
    await page.waitForTimeout(1000);
  ...
  // Skipped: Account search API response too slow in CI environment
  test.skip("Validate that got results for Account Name and all Operation Types properties", async ({
    page,
  }) => {
    test.slow();
    await mainPage.accountSearchSection.click();
