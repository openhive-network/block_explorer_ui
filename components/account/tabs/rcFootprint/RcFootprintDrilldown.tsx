...
import { Loader2, ExternalLink, X, Info } from "lucide-react";
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button
                  ...
                  aria-label={t("rcFootprint.viewInOperations", { category })}
                  className="rounded p-1 text-gray-400 hover:bg-gray-100 hover:text-link dark:hover:bg-gray-800"
                >
