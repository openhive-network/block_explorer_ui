        ...
        >
          ...
          <Legend
            ...
            wrapperStyle={{
              ...
              flexWrap: "wrap", // only wrap on very small screens
              gap: "12px", // space between legend items
              paddingTop: "0px", // maintain original vertical position
            }}
            content={(props) => {
              const { payload } = props;
              return (
                  ...
                  {selectedCoinType === "VESTS" && (
                    <li className="flex items-center gap-1 flex-shrink-0">
                      ...
                      <Switch
                        ...
                        className="w-12 h-6 flex-shrink-0" // consistent toggle size
                      />
