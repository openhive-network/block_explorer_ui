...
const BlockDetails: React.FC<BlockDetailsProps> = ({
  ...
  return (
    <div className="flex flex-col w-full md:w-4/6 mx-auto mb-4 text-white rounded shadow-xl border border-explorer-bg-start bg-explorer-dark-gray text-center">
