...
export const DEFAULT_MASTER_LAYOUT: Layout[] = [
  ...
  { i: "voting-activity-1", x: 3, y: 12.7, w: 3, h: 5.8, minW: 2, minH: 4 },
  { i: "tx-stats-1", x: 3, y: 18.5, w: 6, h: 5.8, minW: 3, minH: 4 },
  { i: "transfer-volume-1", x: 3, y: 24.3, w: 6, h: 5.8, minW: 3, minH: 4 },
  { i: "tvl-1", x: 3, y: 30.1, w: 6, h: 4.6, minW: 3, minH: 4 },
  { i: "hp-momentum-1", x: 3, y: 34.7, w: 6, h: 9, minW: 3, minH: 6 },
  { i: "searches-1", x: 3, y: 43.7, w: 6, h: 9, minW: 4, minH: 11 },
