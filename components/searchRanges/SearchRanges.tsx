...
const SearchRanges: React.FC<SearchRangesProps> = ({
  ...
  return (
    <div className="border-y border-solid border-gray-600 py-2 flex flex-col gap-y-2">
      ...
      >
        <SelectTrigger className="w-1/2 border-0 border-b-2 bg-theme dark:bg-theme ">
          {
        ...
        <SelectContent className="bg-white text-black rounded-sm max-h-[31rem] dark:bg-theme dark:text-white">
        ...
        <>
          <div className="flex items-center justify-center">
            <div className="flex flex-col w-full mr-2">
              <Input
                type="number"
                className="bg-theme dark:bg-theme border-0 border-b-2 text-white"
            ...
            <Select onValueChange={setTimeUnitSelectKey}>
              <SelectTrigger className="pl-2 bg-theme dark:bg-theme border-0 border-b-2 text-white">
                {
              ...
              <SelectContent
                className="bg-white text-black rounded-sm max-h-[31rem] dark:bg-theme dark:text-white"
      ...
      {rangeSelectKey === "blockRange" && (
        <div className="flex items-center">
          <div className="flex flex-col w-full mr-2">
            <Input
              type="number"
              className="bg-theme dark:bg-theme border-0 border-b-2"
